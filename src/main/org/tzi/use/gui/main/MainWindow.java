...
public class MainWindow extends JFrame implements StateChangeListener {
    ...
    private final static String DEFAULT_UNDO_TEXT = "Undo last state command";
    private final static String STATE_EVAL_OCL = "Evaluate OCL expression";
    private PageFormat fPageFormat;

    private static MainWindow fInstance; // global instance of main window

    private JButton addToToolBar(JToolBar toolBar, 
	...
	addToToolBar(toolBar, fActionViewCreateObjectProperties, 
	...
	//addToToolBar(toolBar, fActionViewCreateStateTree, "Create state tree view");
	...
	fMenuItemEditUndo.setAccelerator(
	...
	fCbMenuItemCheckStructure = 
	    new JCheckBoxMenuItem("Check structure after every change");
	fCbMenuItemCheckStructure.setMnemonic('h');
	fCbMenuItemCheckStructure.setSelected(true);
	...
	mi.setMnemonic('i');
	//mi = submenu.add(fActionViewCreateStateTree);
	// experimental: must be enabled by switch at run-time
	if ( Options.extClassDiagram ) {
	    mi = menu.add(fActionViewClassDiagram);
	}
	...
	if ( e.structureHasChanged() && fCbMenuItemCheckStructure.isSelected() )
	    checkStructure();
	fActionFileSaveScript.setEnabled(fSession.system().numExecutedCmds() > 0);
    }
    ...
    /**
     * Creates a new object. Keeps track of undo information and
     * handles errors on the GUI level.
     */
	...
	if ( cls == null ) {
	    JOptionPane.showMessageDialog(this, "No class named `" + clsName + 
	...
	ActionFileOpenSpec() {
	    super("Open specification...", new ImageIcon(Options.iconDir + "Open.gif"));
	}
	...
	private void compile(final File f) {
	    fLogWriter.println("compiling specification " + f.getName() + "...");
	    MModel model = null;
	    MSystem system = null;
	    Reader r = null;
	    try {
	...
	ActionFileSaveScript() {
	    super("Save script...", new ImageIcon(Options.iconDir + "Save.gif"));
	}
	public void actionPerformed(ActionEvent e) {
	    String path;
	    // reuse chooser if possible
	...
	ActionFilePrint() {
	    super("Print diagram...", 
		  new ImageIcon(Options.iconDir + "Print.gif"));
	...
	public void actionPerformed(ActionEvent e) {
	    CreateObjectDialog dlg = 
		new CreateObjectDialog(fSession.system(), MainWindow.this);
	    dlg.setVisible(true);
	}
    }
	...
	ActionStateEvalOCL() {
	    super("Evaluate OCL expression...", 
		  new ImageIcon(Options.iconDir + "OCL.gif"));
	}

	public void actionPerformed(ActionEvent e) {
	    EvalOCLDialog dlg = new EvalOCLDialog(fSession.system(),MainWindow.this);
	    dlg.setVisible(true);
	}
    }
	...
	ActionViewCreateObjectCount() {
	    super("Object count",
		  new ImageIcon(Options.iconDir + "ObjectCountView.gif"));
	}

	public void actionPerformed(ActionEvent e) {
	    ObjectCountView ov = new ObjectCountView(fSession.system());
	    ViewFrame f = new ViewFrame("Object count", ov, "ObjectCountView.gif");
	...
	ActionViewCreateLinkCount() {
	    super("Link count",
		  new ImageIcon(Options.iconDir + "LinkCountView.gif"));
	}
	...
	ActionViewCreateObjectDiagram() {
	    super("Object diagram", 
		  new ImageIcon(Options.iconDir + "ObjectDiagram.gif"));
	}

	public void actionPerformed(ActionEvent e) {
	    NewObjectDiagramView odv = 
		new NewObjectDiagramView(MainWindow.this, fSession.system());
	...
	ActionViewCreateClassInvariant() {
	    super("Class invariants",
		  new ImageIcon(Options.iconDir + "InvariantView.gif"));
	}

	public void actionPerformed(ActionEvent e) {
	    ClassInvariantView civ = new ClassInvariantView(fSession.system());
	...
	ActionViewCreateStateEvolution() {
	    super("State evolution",
		  new ImageIcon(Options.iconDir + "LineChartView.gif"));
	}

	public void actionPerformed(ActionEvent e) {
	    StateEvolutionView sev = new StateEvolutionView(fSession.system());
	    ViewFrame f = new ViewFrame("State evolution", sev, "LineChartView.gif");
	    JComponent c = (JComponent) f.getContentPane();
	    c.setLayout(new BorderLayout());
	...
	ActionViewCreateObjectProperties() {
	    super("Object properties", 
		  new ImageIcon(Options.iconDir + "ObjectProperties.gif"));
	}

	public void actionPerformed(ActionEvent e) {
	    ObjectPropertiesView opv = 
		new ObjectPropertiesView(MainWindow.this, fSession.system());
	    ViewFrame f = 
		new ViewFrame("Object properties", opv, "ObjectProperties.gif");
	    JComponent c = (JComponent) f.getContentPane();
	    c.setLayout(new BorderLayout());
	...
	ActionViewCreateClassExtent() {
	    super("Class extent", 
		  new ImageIcon(Options.iconDir + "ClassExtentView.gif"));
	}

	public void actionPerformed(ActionEvent e) {
	    ClassExtentView cev = 
		new ClassExtentView(MainWindow.this, fSession.system());
	    ViewFrame f = 
		new ViewFrame("Class extent", cev, "ClassExtentView.gif");
	    JComponent c = (JComponent) f.getContentPane();
	    c.setLayout(new BorderLayout());
	...
	ActionViewCreateSequenceDiagram() {
	    super("Sequence diagram",
		  new ImageIcon(Options.iconDir + "SequenceDiagram.gif"));
	}

	public void actionPerformed(ActionEvent e) {
	    SequenceDiagramView sv = new SequenceDiagramView(fSession.system());
	...
	public void actionPerformed(ActionEvent ev) {
	    // FIXME: ClassDiagramView cdv = new ClassDiagramView(fSession.system().model());
	}
    }
...
//  	Object[] arr = GraphicsEnvironment.getLocalGraphicsEnvironment().getAllFonts();
//  	//Object[] arr = GraphicsEnvironment.getLocalGraphicsEnvironment().getAvailableFontFamilyNames();
