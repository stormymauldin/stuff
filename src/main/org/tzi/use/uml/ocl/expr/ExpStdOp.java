...
/* This class is only used for +, *, -, max, min on Integers and
   Reals. */
abstract class ArithOperation extends OpGeneric {
    public int kind() { return OPERATION; }
...
final class Op_real_abs extends OpGeneric {
    ...
    public Type matches(Type params[]) {
	return ( params.length == 1 && params[0].isReal() )
	    ? TypeFactory.mkReal() : null;
    }
...
final class Op_integer_abs extends OpGeneric {
    ...
    public Type matches(Type params[]) {
	return ( params.length == 1 && params[0].isInteger() )
...
final class Op_number_unaryminus extends OpGeneric {
    ...
    public Type matches(Type params[]) {
	return ( params.length == 1 && params[0].isNumber() )
	    ? params[0] : null;
    }
...
final class Op_number_less extends OpGeneric {
    public String name() { return "<"; }
    public int kind() { return PREDICATE; }
    public boolean isInfixOrPrefix() { return true; }
...
final class Op_string_toLower extends OpGeneric {
    public String name() { return "toLower"; }
    public int kind() { return OPERATION; }
    public boolean isInfixOrPrefix() { return false; }
...
/**
 * This class is the base class for boolean operations. Boolean
 * operations need special treatment of undefined arguments. Also,
 * short-circuit evaluation may be used to speed up the evaluation
 * process.
 */
abstract class BooleanOperation extends OpGeneric {
    public int kind() { return SPECIAL; }
    public Value eval(EvalContext ctx, Value[] args, Type resultType) {
	throw new RuntimeException("Use evalWithArgs");
    }
    abstract public Value evalWithArgs(EvalContext ctx, Expression args[]);
}
...
final class Op_boolean_not extends BooleanOperation {
    ...
    public Type matches(Type params[]) {
	return ( params.length == 1 && params[0].isBoolean() )
	    ? params[0] : null;
    }
...
final class Op_collection_size extends OpGeneric {
    ...
    public Type matches(Type params[]) {
	return ( params.length == 1 && params[0].isCollection() )
	    ? TypeFactory.mkInteger() : null;
    }
...
final class Op_collection_includes extends OpGeneric {
    public String name() { return "includes"; }
...
final class Op_collection_excludes extends OpGeneric {
    public String name() { return "excludes"; }
...
final class Op_collection_includesAll extends OpGeneric {
    public String name() { return "includesAll"; }
    public int kind() { return OPERATION; } 
    public boolean isInfixOrPrefix() { return false; }

    public Type matches(Type params[]) {
	if ( params.length == 2 
	     && params[0].isCollection() 
...
final class Op_collection_excludesAll extends OpGeneric {
    public String name() { return "excludesAll"; }
    public int kind() { return OPERATION; } 
    public boolean isInfixOrPrefix() { return false; }
...
final class Op_collection_isEmpty extends OpGeneric {
    public String name() { return "isEmpty"; }
    public int kind() { return PREDICATE; } 
    public boolean isInfixOrPrefix() { return false; }
...
final class Op_collection_notEmpty extends OpGeneric {
    public String name() { return "notEmpty"; }
    public int kind() { return PREDICATE; } 
    public boolean isInfixOrPrefix() { return false; }
...
final class Op_collection_flatten extends OpGeneric {
	...
	if ( params.length == 1 && params[0].isCollection() ) {
		...
		// Sequence(Set(T)) and Sequence(Bag(T)) is not
		// well-defined!
	    }
	}
	return null;
...
final class Op_set_intersection extends OpGeneric {
    public String name() { return "intersection"; }
    public int kind() { return OPERATION; } 
    public boolean isInfixOrPrefix() { return false; }
...
final class Op_set_including extends OpGeneric {
    public String name() { return "including"; }
    public int kind() { return SPECIAL; } 
    public boolean isInfixOrPrefix() { return false; }
...
final class Op_set_excluding extends OpGeneric {
    public String name() { return "excluding"; }
    public int kind() { return SPECIAL; } 
    public boolean isInfixOrPrefix() { return false; }
...
final class Op_set_symmetricDifference extends OpGeneric {
    public String name() { return "symmetricDifference"; }
    public int kind() { return OPERATION; } 
    public boolean isInfixOrPrefix() { return false; }
...
final class Op_set_asSequence extends OpGeneric {
    public String name() { return "asSequence"; }
    public int kind() { return OPERATION; }
    public boolean isInfixOrPrefix() { return false; }
...
final class Op_set_asBag extends OpGeneric {
    public String name() { return "asBag"; }
    public int kind() { return OPERATION; }
    public boolean isInfixOrPrefix() { return false; }
...
final class Op_sequence_prepend extends OpGeneric {
    public String name() { return "prepend"; }
    public int kind() { return OPERATION; } 
    public boolean isInfixOrPrefix() { return false; }
...
final class Op_sequence_subSequence extends OpGeneric {
    public String name() { return "subSequence"; }
    public int kind() { return OPERATION; }
    public boolean isInfixOrPrefix() { return true; }
...
final class Op_mkSet extends OpGeneric {
    public String name() { return "mkSet"; }
...
final class Op_mkSetRange extends OpGeneric {
    public String name() { return "mkSetRange"; }
    public int kind() { return OPERATION; } 
    public boolean isInfixOrPrefix() { return false; }
	...
	return ( params.length >= 2 && params.length % 2 == 0
		 && params[0].isInteger()
		 && params[1].isInteger() )
	    ? TypeFactory.mkSet(TypeFactory.mkInteger()) : null;
    }
...
final class Op_mkSequence extends OpGeneric {
    public String name() { return "mkSequence"; }
    // may include undefined elements
    public int kind() { return SPECIAL; } 
    public boolean isInfixOrPrefix() { return false; }
...
final class Op_mkSequenceRange extends OpGeneric {
    public String name() { return "mkSequenceRange"; }
    public int kind() { return OPERATION; } 
    public boolean isInfixOrPrefix() { return false; }
	...
	return ( params.length >= 2 && params.length % 2 == 0
		 && params[0].isInteger()
		 && params[1].isInteger() )
	    ? TypeFactory.mkSequence(TypeFactory.mkInteger()) : null;
    }
...
final class Op_mkBag extends OpGeneric {
    public String name() { return "mkBag"; }
    // may include undefined elements
    public int kind() { return SPECIAL; } 
    public boolean isInfixOrPrefix() { return false; }
...
final class Op_mkBagRange extends OpGeneric {
    public String name() { return "mkBagRange"; }
    public int kind() { return OPERATION; } 
    public boolean isInfixOrPrefix() { return false; }
	...
	return ( params.length >= 2 && params.length % 2 == 0
		 && params[0].isInteger()
		 && params[1].isInteger() )
	    ? TypeFactory.mkBag(TypeFactory.mkInteger()) : null;
    }
...
final class Op_equal extends OpGeneric {
    ...
    public Type matches(Type params[]) {
	if ( params.length == 2 
	     && ( params[1].isSubtypeOf(params[0])
		  || params[0].isSubtypeOf(params[1]) ) )
	    return TypeFactory.mkBoolean();
	else
	    return null;
    }
...
final class Op_isDefined extends OpGeneric {
    public String name() { return "isDefined"; }
    public int kind() { return SPECIAL; }
    public boolean isInfixOrPrefix() { return false; }
...
final class Op_isUndefined extends OpGeneric {
    public String name() { return "isUndefined"; }
    public int kind() { return SPECIAL; }
    public boolean isInfixOrPrefix() { return false; }
...
final class Op_oclIsNew extends OpGeneric {
    public String name() { return "oclIsNew"; }
    public int kind() { return OPERATION; }
    public boolean isInfixOrPrefix() { return false; }
